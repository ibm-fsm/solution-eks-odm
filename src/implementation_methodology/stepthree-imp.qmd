...
Download the [Miniloan Service.zip](https://github.com/DecisionsDev/odm-for-container-getting-started/blob/master/Miniloan%20Service.zip) and execution-payload.json from the following [repo](https://github.com/DecisionsDev/odm-for-container-getting-started).
