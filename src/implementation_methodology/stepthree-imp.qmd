...
3.  Expand RuleApps at the left-hand sidebar, and then expand /mydeployment/1.0. 
4.  Click /Miniloan_ServiceRuleset/1.0 to view the details of the ruleset in the Ruleset View.
5.  CLick Test ruleset
6.  Paste the payload from execution-payload.json
```
